var app = angular.module('wds-hammer', ['hmTouchEvents']);

angular.module('wds-hammer').controller('WdsCtrl', function($scope) {
  var vm = this;
...
(function(window, angular, Hammer){
    ...
    angular.forEach(hmGestures, function(name){
        ...
        console.log('Hammer directive: ' + directiveName);

        hmTouchEvents.directive(directiveName, ['$parse', '$window', function($parse, $window){
            return {
                restrict: 'A, C',
                link: function(scope, element, attr) {
                    console.log('Binding event:' + directiveName);
